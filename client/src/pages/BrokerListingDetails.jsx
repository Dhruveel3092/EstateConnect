          ...
          <div className="p-6">
            ...
            <div className="mt-8 border-t pt-6">
              ...
              {biddingStatus === 'completed' && highestBidder ? (
                <p className="text-md mb-2 flex items-center gap-2 text-green-700">
                  <FaUserCheck /> <strong>Highest Bidder:</strong> {highestBidder.username} ({highestBidder.email}) – ₹
              ...
              <div className="mt-6">
                <p className="text-md mb-2 flex items-center gap-2">
                  <FaUser /> <strong>Seller:</strong> {seller?.username} ({seller?.email})
                </p>
              </div>
            </div>
          </div>
